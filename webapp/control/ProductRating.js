sap.ui.define([
    ...
    return Control.extend("sap.ui.demo.walkthrough.control.ProductRating", {
        // Define a estrutura de dados do control
        metadata: {
            properties: {
                value: {
                    type: "float",
        ...
        // Faz o set up do control e prepara o conteúdo a ser mostrado em tela
        init: function () {
        ...
        // Define qual estrutura HTML vai ser adicionada na DOM
